...
import { Mail, Lock, User, MapPin, Briefcase, Eye, EyeOff, Heart } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Join Zyra AI</h2>
          <p className="text-gray-600">Create your account to find your perfect roommate</p>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="submit"
              className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3 px-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-200"
            >
              Create Account
            </motion.button>
          </form>
